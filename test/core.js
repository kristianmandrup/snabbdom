...
if (customElements) {
  // console.log('define', 'my-elem', MyElem)
...
describe('snabbdom', function () {
  ...
  describe('created element', function () {
    ...
    it('is receives classes in class property', function () {
      elm = patch(vnode0, h('i', {
        class: {
          am: true, a: true, class: true, not: false
        }
      })).elm;
  ...
  describe('patching an element', function () {
    it('changes the elements classes', function () {
      var vnode1 = h('i', {
        class: {
          i: true, am: true, horse: true
        }
      });
      var vnode2 = h('i', {
        class: {
          i: true, am: true, horse: false
        }
      });
      patch(vnode0, vnode1);
    ...
    describe('updating children with keys', function () {
      ...
      it('handles random shuffles with null/undefined children', function () {
        var i, j, r, len, arr, maxArrLen = 15,
          samples = 5,
          vnode1 = vnode0,
          vnode2;
